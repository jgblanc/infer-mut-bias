...
## Main program 
all_reps = []
for i in range(int(parameters[7])):
    ts = msprime_simulate(int(parameters[0]), float(parameters[1]), float(parameters[2]), float(parameters[3]), float(parameters[4]), int(parameters[5])+i)
    ...
    all_reps.append(dat)
out = bin_frequencies(all_reps, int(parameters[6]))
